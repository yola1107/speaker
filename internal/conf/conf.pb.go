...
type Server struct {
	...
	Gnet          *Server_Gnet           `protobuf:"bytes,5,opt,name=gnet,proto3" json:"gnet,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Server) GetGnet() *Server_Gnet {
	if x != nil {
		return x.Gnet
	}
	return nil
...
func (x *Server_Gnet) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_Gnet) ProtoMessage() {}

func (x *Server_Gnet) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_Gnet.ProtoReflect.Descriptor instead.
func (*Server_Gnet) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{1, 4}
}

func (x *Server_Gnet) GetNetwork() string {
	if x != nil {
		return x.Network
	}
	return ""
...
func (x *Server_Gnet) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *Server_Gnet) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
func (x *Data_RabbitMQ) GetPort() string {
	if x != nil {
		return x.Port
	}
	return ""
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x04data\x18\x02 \x01(\v2\x10.kratos.api.DataR\x04data\"\x8a\x06\n" +
	"\x06Server\x12+\n" +
	...
	"\twebsocket\x18\x04 \x01(\v2\x16.kratos.api.Server.TCPR\twebsocket\x12+\n" +
	"\x04gnet\x18\x05 \x01(\v2\x17.kratos.api.Server.GnetR\x04gnet\x1ai\n" +
	"\x04HTTP\x12\x18\n" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xb3\x04\n" +
	"\x04Data\x125\n" +
	...
	"\rwrite_timeout\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\x1a\x80\x01\n" +
	"\bRabbitMQ\x12\x12\n" +
	"\x04host\x18\x01 \x01(\tR\x04host\x12\x12\n" +
	"\x04port\x18\x02 \x01(\tR\x04port\x12\x1a\n" +
	"\busername\x18\x03 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x04 \x01(\tR\bpassword\x12\x14\n" +
	"\x05vhost\x18\x05 \x01(\tR\x05vhostB\x1cZ\x1aspeaker/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	7,  // 6: kratos.api.Server.gnet:type_name -> kratos.api.Server.Gnet
	8,  // 7: kratos.api.Data.database:type_name -> kratos.api.Data.Database
	9,  // 8: kratos.api.Data.redis:type_name -> kratos.api.Data.Redis
	10, // 9: kratos.api.Data.rabbitmq:type_name -> kratos.api.Data.RabbitMQ
	...
	11, // 12: kratos.api.Server.TCP.timeout:type_name -> google.protobuf.Duration
	11, // 13: kratos.api.Server.Websocket.timeout:type_name -> google.protobuf.Duration
	11, // 14: kratos.api.Server.Gnet.timeout:type_name -> google.protobuf.Duration
