...
玩法介绍
夺宝符号：
	普通模式中，出现百搭符号，且有女性符号中奖时，中奖的女性符号和百搭符号会消失，自然下落补齐。如果下落补齐后的结果依然有中奖且中奖符号包含女性符号，那么女性符号继续消除，继续补齐，直到没有中奖。如果此种情况发生时屏幕上有夺宝符号，则百搭符号不消失，直到此次spin结束。
夺宝模式触发：
	每列卷轴最多出现1个夺宝符号。
	收集3个夺宝符号赢得7次免费游戏，4个10次，5个15次。在免费游戏中每收集1个夺宝符号则免费游戏次数+1。
女性符号消除：
	在免费游戏中，中奖的女性符号会消除（无需有百搭符号在场），自然下落补齐，如果下落补齐后的结果有中奖且中奖符号包含女性符号，那么女性符号继续消除，继续补齐，直到没有中奖。如果此种情况发生时屏幕上有百搭符号，则百搭符号不消失，直到此次spin结束。
女性符号变女性百搭符号：
	女性符号共有3种，在免费游戏中，任一种女性符号中奖个数达到10，则该女性符号出现后转变为对应的女性百搭符号。
变消除玩法：
	在免费游戏中，3种女性符号全都可以转变为女性百搭后，有女性百搭符号参与的中奖符号（无论是不是女性符号）都会消失（女性百搭符号会消失，但百搭符号不消失），自然下落补齐，意思就是此时就是能够消除的玩法。
