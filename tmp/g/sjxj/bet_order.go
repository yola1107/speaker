...
func gameOrderToResponse(gameOrder *game.GameOrder) (*pb.Sjxj_BetOrderResponse, error) {
	...
	return &pb.Sjxj_BetOrderResponse{
		...
		WinInfo:            winDetail.WinInfo,
		Cards:              int64GridToArray(symbolGrid),
		RemainingFreeTimes: &gameOrder.FreeNum,
		TotalFreeTimes:     &gameOrder.FreeTimes,
