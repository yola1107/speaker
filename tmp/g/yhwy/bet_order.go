...
func gameOrderToResponse(gameOrder *game.GameOrder) (*pb.Yhwy_BetOrderResponse, error) {
	...
	return &pb.Yhwy_BetOrderResponse{
		...
		IsRoundOver:  proto.Bool(true),
		CollectLevel: &winDetail.CollectLevel,
